REPORT CARD ENTERPRISE v7.2.4 FINAL REUSABLE SCHOOLS EDITION
...
1. Run the appended v7.2.4 section of 09_schema.sql in Supabase.
2. Deploy this complete frontend directory.
3. Redeploy platform-package-manager and scheduled-backup.
4. Upload PLATFORM_PACKAGE_TEMPLATE_v7_2_4_FINAL.zip through the Platform Super Administrator portal.
