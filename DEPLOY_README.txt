REPORT CARD ENTERPRISE v7.2.5 FINAL REUSABLE SCHOOLS EDITION
...
1. Run only the appended v7.2.5 section of 09_schema.sql.
...
4. Upload PLATFORM_PACKAGE_TEMPLATE_v7_2_5_FINAL.zip through the Platform Super Administrator portal.
